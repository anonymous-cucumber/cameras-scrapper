...
The different sources are :
  ...
  - **umapChambery**, it is an umap instance which mention cameras in Chambery in France (filled by users) : https://umap.openstreetmap.fr/fr/map/lesyeuxdechambery_985787
