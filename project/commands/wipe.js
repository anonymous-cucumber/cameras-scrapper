...
function getArgs() {
    return {
        subject: async subject => {
            if (subject === undefined || subject.toLowerCase() !== "cameras")
                return {success: false, msg: "You have to mention what you want to wipe"}

            return {success: true, data: subject.toLowerCase()};
        }
    }
}
...
async function execute(_params) {
