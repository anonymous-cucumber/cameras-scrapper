...
async function getDefaultFranceBbox(endpoint, timeout = defaultTimeout) {
    const queryParams = {
...
async function getIdfZoom11Bbox(endpoint, timeout = defaultTimeout) {
  const queryParams = {
...
async function getIdfZoom12Bbox(endpoint, timeout = defaultTimeout) {
  const queryParams = {
...
async function getWholeParisZoom13Bbox(endpoint, timeout = defaultTimeout) {
    const queryParams = {
...
async function getParisCenterBbox(endpoint, timeout = defaultTimeout) {
  const queryParams = {
...
async function getParisChateletLesHallesBbox(endpoint, timeout = defaultTimeout) {
  const queryParams = {
